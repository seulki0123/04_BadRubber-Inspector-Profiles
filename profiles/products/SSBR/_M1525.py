...
_CLUSTER_CLASSES = {
    ...
    # PASS CLASSES
    # =========================
    'Side-2+3_검정배경-날개':                         {"class_id": 17, "name": "side23-black-wing",                 "color": (255, 255, 255), "pass": False},
    'Side-2+3_고무-흐리고-수분이조금있고':            {"class_id": 18, "name": "side23-rubber-moist-blur",          "color": (255, 255, 255), "pass": False},
    'Side-2+3_하얀배경-날개':                         {"class_id": 19, "name": "side23-white-wing",                 "color": (255, 255, 255), "pass": False},

    '고무-어두워':                                    {"class_id": 20, "name": "rubber-dark",                       "color": (255, 255, 255), "pass": False},
    '그냥고무+부스러기등등':                          {"class_id": 21, "name": "rubber-debris-mixed",               "color": (255, 255, 255), "pass": False},

    '부스러기-갈색고무':                              {"class_id": 22, "name": "debris-brown-rubber",               "color": (255, 255, 255), "pass": False},
    '부스러기-갈색고무-딱한개':                       {"class_id": 23, "name": "debris-brown-rubber-one",           "color": (255, 255, 255), "pass": False},
    '부스러기-황토고무':                              {"class_id": 24, "name": "debris-yellow-rubber",              "color": (255, 255, 255), "pass": False},

    '수분-부스러기섞인-부스러기':                     {"class_id": 25, "name": "moist-debris-mixed",                "color": (255, 255, 255), "pass": False},

    '짝대기':                                         {"class_id": 26, "name": "bar-line",                          "color": (255, 255, 255), "pass": False},

    '크랙':                                           {"class_id": 27, "name": "crack",                             "color": (255, 255, 255), "pass": False},
    '크랙-Side':                                      {"class_id": 28, "name": "crack-side",                        "color": (255, 255, 255), "pass": False},

    '테두리-삐쭉날개':                                {"class_id": 29, "name": "edge-sharp-wing",                   "color": (255, 255, 255), "pass": False},
    '테두리-파란배경-스트라이프':                     {"class_id": 30, "name": "edge-blue-stripe",                  "color": (255, 255, 255), "pass": False},

    '파란색':                                         {"class_id": 31, "name": "blue",                              "color": (255, 255, 255), "pass": False},
    '파란색-고무조금보여':                            {"class_id": 32, "name": "blue-rubber-small",                 "color": (255, 255, 255), "pass": False},
    '파란색-날개보여':                                {"class_id": 33, "name": "blue-wing",                         "color": (255, 255, 255), "pass": False},
    '파란색-날개보여-매우삐쭉':                       {"class_id": 34, "name": "blue-wing-sharp",                   "color": (255, 255, 255), "pass": False},

    '하얀':                                           {"class_id": 35, "name": "white-object",                      "color": (255, 255, 255), "pass": False},

    '후_NBR에서가져온거-검정-쓰레기':                 {"class_id": 36, "name": "after-nbr-black-trash",             "color": (255, 255, 255), "pass": False},
}
...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return replace(
        ...
        segmenter={
            "checkpoint": f"{root}/defect/segment/weights/SSBR/G1-F1038+M0511/19_13+14-2+16-12/weights/best.pt",
            "imgsz": 640,
            "threshold": 0.25,
        },
    )