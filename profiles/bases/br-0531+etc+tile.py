...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return Profile(
        ...
        tile_detector={
            "checkpoint": f"{root}/defect/segment/weights/BR-C/G1/23_17+18+19+20+22-1/weights/best.pt",
            "imgsz": 1024,
            "threshold": 0.5,
            "tile_overlap_x": 0.0,
            "tile_overlap_y": 0.0,
        ...
        baler_classifier={
            "checkpoint": f"{root}/baler/weights/BR-A/br_a_all_paired/best_model.pth",
            "img_size": 224,
            "num_classes": None,
