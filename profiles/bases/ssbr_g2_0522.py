...
_CLASSIFY_CLASSES = {
    ...
    4:  {"description": "OK-갈라짐",                 "name": "drain",                "color": (255, 255, 255), "pass": False},
    5:  {"description": "OK-갈라짐-테두리쪽",        "name": "drain-edge",           "color": (255, 255, 255), "pass": False},
    6:  {"description": "OK-검정배경-날개삐쭉",       "name": "black-wings",          "color": (255, 255, 255), "pass": False},
    7:  {"description": "OK-그냥고무",               "name": "rubber",               "color": (255, 255, 255), "pass": False},
    8:  {"description": "OK-양각-밝은",              "name": "dash-light",           "color": (255, 255, 255), "pass": False},
    9:  {"description": "OK-양각-어두운",            "name": "dash-dark",            "color": (255, 255, 255), "pass": False},
    10: {"description": "OK-조명배경-날개삐쭉",      "name": "light-wings",          "color": (255, 255, 255), "pass": False},
    11: {"description": "OK-조명배경-모서리",         "name": "light-edge",           "color": (255, 255, 255), "pass": False},
    12: {"description": "OK-테두리-아래-거의배경",    "name": "edge-bottom-light",    "color": (255, 255, 255), "pass": False},
    13: {"description": "OK-테두리-아래-날개많이",    "name": "edge-bottom-wings",    "color": (255, 255, 255), "pass": False},
    14: {"description": "OK-테두리-아래-날개중간",    "name": "edge-bottom-wings-middle", "color": (255, 255, 255), "pass": False},
    15: {"description": "OK-테두리-옆",              "name": "edge-side",            "color": (255, 255, 255), "pass": False},
    16: {"description": "OK-테두리-튀어나온",        "name": "edge-up",              "color": (255, 255, 255), "pass": False},
}
...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return Profile(
        ...
        segmenter={
            "checkpoint": f"{root}/defect/segment/weights/SSBR/G2-F3626Y+2550H/12_10-2+112/weights/best.pt",
            "imgsz": 640,
            "threshold": 0.25,
        },
        dot_detector1=None,
