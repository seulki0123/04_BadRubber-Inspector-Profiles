...
_CLUSTER_CLASSES = {
    ...
    # NG - foreign
    'NG-이물-컬러':                {"class_id": 14, "name": "foreign",      "color": (0,0,255), "pass": True},
    'NG-이물-거뭇거뭇':            {"class_id": 15, "name": "foreign",       "color": (0,0,255), "pass": True},
    'NG-이물-점':                  {"class_id": 16, "name": "foreign",       "color": (0,0,255), "pass": True},
...
_CLASSIFY_CLASSES = {
    ...
    1: {"description": "NG-2-이물-블랙",     "name": "foreign",                    "color": (0, 0, 255),     "pass": True},
    2: {"description": "NG-2-이물-컬러",     "name": "foreign",                     "color": (0, 0, 255),     "pass": True},
...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return Profile(
        ...
        dot_detector2=None,
        tile_detector={
            "checkpoint": f"{root}/defect/segment/weights/NBR/G1+G2+G3/25_dot_dataset/weights/best.pt",
            "imgsz": 1024,
            "threshold": 0.5,
            "tile_overlap_x": 0.0,
            "tile_overlap_y": 0.0,
