...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return Profile(
        ...
        patchcore={
            "checkpoint": f"{root}/defect/patchcore/weights/BR-B/_intergrated/20260615/bank_res256.pt",
            "holdout": f"{root}/defect/patchcore/weights/BR-B/_intergrated/20260615/holdout_scores_res256.json",
