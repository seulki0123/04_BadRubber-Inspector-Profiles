...
def build_profile(checkpoint_root: str) -> Profile:
    ...
    return Profile(
        ...
        classifier={
            "checkpoint": f"{root}/defect/classify/weights/SSBR/G2-F3626Y+2550H/03_01+02_hm_0514/best_E70.pt",
            "imgsz": 640,
            "threshold": 0.0,
        },
        segmenter={
            "checkpoint": f"{root}/defect/segment/weights/SSBR/G2-F3626Y+2550H/01_20260404_hm_0514/best.pt",
            "imgsz": 640,
            "threshold": 0.25,
        },
        dot_detector1=None,
